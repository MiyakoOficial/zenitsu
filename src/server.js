...
client.on('message', async (message) => {
    ...
    if (command === 'suggest') {
        ...
        new Discord.WebhookClient('726105436503146587', 'a4RkLOAs8nWw3_laerlEjIH_z8ekvph-EHXRi0JaWpu_3B7x10iWEZjuGPR6ujgngY94').send(`${message.author.username} ha sugerido:\n${args.join(' ')}`).then(a => { embedResponse('Sugerencia enviada!') }
        )
    }
    //fin suggest
    //inicio de extras
